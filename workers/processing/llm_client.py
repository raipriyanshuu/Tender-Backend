...
def _build_critical_fields_prompt(text: str, source_filename: str = "document") -> str:
    ...
    return (
        ...
        "Valid sources (search for these terms):\n"
        "- \"Angebotsfrist\"\n"
        "- \"Abgabefrist\"\n"
        "- \"Schlusstermin\"\n"
        ...
        "- Any date preceded by these terms or similar deadline-related phrases\n\n"
        "Date format recognition:\n"
        "- DD.MM.YYYY (e.g., 15.02.2025, 01.03.2026)\n"
        "- DD/MM/YYYY\n"
        "- YYYY-MM-DD\n"
        "- DD. Month YYYY (e.g., 15. Februar 2025)\n"
        "- Text like \"bis zum 15.02.2025\" or \"spätestens am 01.03.2026\"\n\n"
        "INVALID sources:\n"
        "- Project start/end dates (Projektbeginn, Projektende)\n"
        "- Execution timelines (Ausführungszeitraum)\n"
        "- Contract duration (Vertragslaufzeit, Bauzeit)\n"
        "- Internal milestones\n\n"
        "Formatting:\n"
        "- Convert ALL dates to STRICT YYYY-MM-DD format\n"
        "- Examples: \"15.02.2025\" → \"2025-02-15\", \"01.03.2026\" → \"2026-03-01\"\n"
...
def _build_extraction_prompt(text: str, source_filename: str = "document") -> str:
    ...
    return (
        ...
        "SPECIAL FIELD: project_duration_de\n"
        "Extract the project execution duration (NOT submission deadline):\n"
        "- Look for terms: 'Bauzeit', 'Projektdauer', 'Ausführungszeitraum', 'Vertragslaufzeit', 'Laufzeit'\n"
        "- Common formats: '24 Monate', '2 Jahre', '6 Monate', '18 Monate'\n"
        "- Extract EXACT text as written (e.g., '24 Monate', NOT 'über die komplette Bauzeit')\n"
        "- If duration is vague (e.g., 'über die komplette Bauzeit'), set to null\n"
        "- If duration is a date range, convert to months/years (e.g., '01.2025 - 12.2026' → '24 Monate')\n\n"
